"""
Security module for PrintShop CRM application.

This module provides password hashing and JWT token creation/validation functionality.
"""
...
# Configure bcrypt with builtin backend to avoid initialization errors
